...
- Name: production_flow.spec.ts >> RideSync Production Flow >> Joining via Tactical Code
- Location: tests\e2e\production_flow.spec.ts:74:3
...
Locator: locator('h1')
Expected pattern: /Enter Tactical Code/i
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1')
    2 × locator resolved to <h1 class="text-5xl font-black text-foreground leading-tight tracking-tight">The ultimate coordination hub for motorcyclists.</h1>
      - unexpected value "The ultimate coordination hub for motorcyclists."
